...
if __name__ == "__main__":
    index_name = "financial-index-test"  # name of the search index
    datasource_name = "fa-datasource"  # name of the datasource (in Azure Search)
    container_name = (
        "namstorage"  # name of the storage container (in Azure Blob Storage)
    )
    indexer_name = "financial-indexer-test"  # name of the indexer we want to create
